...
console.log(lab1.questionOne([13, 32, 33])); 
console.log(lab1.questionOne([11, 12, 13])); 
console.log(lab1.questionOne([14, 24, 34])); 
console.log(lab1.questionOne([16, 26, 36])); 
console.log(lab1.questionOne([17, 27, 37])); 
// should output 14
console.log("End of function 1 testing ");
